        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card card-user">
              <div class="image">
                <img src="{{ asset ('template/assets/img/damir-bosnjak.jpg') }}" alt="">
              </div>
              <div class="card-body">
                <div class="author">
                  <a href="#">
                    <img class="avatar border-gray" src="{{ asset ('template/assets/img/mike.jpg') }}" alt="">
                ...
                <ul class="list-unstyled team-members">
                  <li>
                    <div class="row">
                      <div class="col-md-2 col-2">
                        <div class="avatar">
                          <img src="{{ asset ('template/assets/img/faces/ayo-ogunseinde-2.jpg') }}" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                        </div>
                      </div>
                  ...
                  <li>
                    <div class="row">
                      <div class="col-md-2 col-2">
                        <div class="avatar">
                          <img src="{{ asset ('template/assets/img/faces/joe-gardner-2.jpg') }}" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                        </div>
                      </div>
                      <div class="col-md-7 col-7">
                        Creative Tim
                  ...
                  <li>
                    <div class="row">
                      <div class="col-md-2 col-2">
                        <div class="avatar">
                          <img src="{{ asset ('template/assets/img/faces/clem-onojeghuo-2.jpg') }}" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                        </div>
                      </div>
