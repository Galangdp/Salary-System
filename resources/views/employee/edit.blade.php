                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="font-weight-bold d-flex justify-content-center align-items-center">Edit Data
                                    Employee</h4>
                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control" type="text"
                                                    placeholder="{{$employee -> users -> name}}" readonly>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    <label for="photo" class="custom-file-label"
                                                        id="fileName">{{$employee->photo}}</label>
                                                </div>
                                            </div>
                                        </div>
